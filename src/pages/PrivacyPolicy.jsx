...
export default function PrivacyPolicy() {
  return (
    <section className="bg-gray-50 py-10 sm:py-16 lg:py-24 overflow-x-hidden">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow-sm sm:shadow-md rounded-2xl sm:rounded-3xl border border-gray-100 p-5 sm:p-8 md:p-12 text-gray-700 leading-relaxed text-sm sm:text-base">
          
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900 tracking-tight mb-6 sm:mb-8 border-b border-gray-100 pb-3 sm:pb-4">
            Privacy Policy
          </h1>
          ...
          <div className="mb-8 sm:mb-10">
            ...
            <p className="mb-3 sm:mb-4">
              Kaarwaa.N collects information from the users in a number of ways, for example when the user:
            </p>
            <ul className="list-disc pl-5 sm:pl-6 mb-3 sm:mb-4 space-y-1 sm:space-y-1.5 text-gray-600">
              <li>Makes a donation</li>
              <li>Signs up for a member and volunteer login</li>
              <li>Submits creative ideas and feedbacks</li>
            </ul>
          ...
          <div className="mb-8 sm:mb-10">
            ...
            <p className="mb-3 sm:mb-4">Kaarwaa.N uses the information given to it in the following ways:</p>
            <ul className="list-disc pl-5 sm:pl-6 mb-3 sm:mb-4 space-y-1 sm:space-y-1.5 text-gray-600">
              <li>To keep an accurate record of all the donations received</li>
              <li>To update users about its happenings and developments through bulletins and newsletters, with an option of not to subscribe for the same</li>
              <li>To make sure the user is receiving the most appropriate and relevant information</li>
          ...
          <div className="mt-10 sm:mt-12 pt-6 sm:pt-8 border-t border-gray-200">
            ...
            <address className="not-italic text-gray-600 text-xs sm:text-sm space-y-1">
              <p className="font-semibold text-gray-800 text-sm sm:text-base">Kaarwaa.N</p>
              <p>Jabalpur Engineering College, Gokulpur</p>
              <p>Jabalpur (M.P.) - 482011</p>
              <p className="pt-1.5">
                <span className="font-medium text-gray-900">Phone:</span>{" "}
                <a href="tel:+919149720731" className="text-amber-600 hover:underline">
                  +91 91497 20731
                </a>
              </p>
            </address>
