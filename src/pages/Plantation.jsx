...
import { Link } from "react-router-dom";
import { 
  Heart, Sprout, CloudRain, TreeDeciduous, 
  Sun, Leaf, Flower2, Shovel
} from "lucide-react";
import imgHero1 from '../asset/plantcover.jpeg';
import imgHero2 from '../asset/img7.jpg';
import imgHero3 from '../asset/img8.jpg';
...
const TreePlantation = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAF9] text-slate-900 font-sans selection:bg-emerald-200 overflow-x-hidden">
      
      {/* --- HERO CAROUSEL --- */}
      <section className="relative w-full h-[75vh] sm:h-[80vh] lg:h-[85vh] overflow-hidden bg-emerald-950">
        <AnimatePresence mode="wait">
          <motion.div
            key={currentSlide}
            initial={{ opacity: 0, scale: 1.1 }}
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 sm:px-6 z-10">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <span className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 rounded-full bg-emerald-800/40 border border-emerald-400/30 text-emerald-300 text-xs sm:text-sm font-bold tracking-widest uppercase mb-4 sm:mb-6 backdrop-blur-md shadow-xl">
              <Leaf size={14} className="animate-pulse shrink-0" /> Kaarwaa.N Green Initiative
            </span>
            <h1 className="text-4xl sm:text-6xl lg:text-7xl xl:text-8xl font-black text-white mb-4 sm:mb-6 tracking-tight drop-shadow-lg leading-tight">
              Roots of <span className="text-emerald-400">Tomorrow</span>
            </h1>
            <p className="text-sm sm:text-xl lg:text-2xl text-emerald-100 max-w-2xl mx-auto font-light leading-relaxed">
              "The best time to plant a tree was 20 years ago. The second best time is now."
            </p>
          </motion.div>
        </div>
        ...
        <div className="absolute bottom-8 sm:bottom-12 left-1/2 -translate-x-1/2 flex gap-2 sm:gap-3 z-20">
          {carouselImages.map((_, idx) => (
            <button
              ...
              className={`h-1.5 transition-all duration-700 rounded-full shadow-lg ${
                currentSlide === idx ? "w-10 sm:w-16 bg-emerald-400" : "w-3 bg-white/30 hover:bg-white/50"
              }`}
            />
          ))}
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 pointer-events-none">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className="fill-[#F8FAF9] h-10 sm:h-16 lg:h-24 w-full block">
            <path fillOpacity="1" d="M0,160L48,176C96,192,192,224,288,213.3C384,203,480,149,576,144C672,139,768,181,864,197.3C960,213,1056,203,1152,181.3C1248,160,1344,128,1392,112L1440,96L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
          </svg>
        </div>
      </section>
      ...
      {/* --- QUICK STATS / MISSION GRID --- */}
      <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          <div className="p-6 sm:p-8 bg-white rounded-2xl sm:rounded-[2rem] border border-emerald-50 shadow-sm hover:shadow-xl hover:shadow-emerald-100/50 transition-all duration-300 group hover:-translate-y-1">
            <div className="w-12 sm:w-16 h-12 sm:h-16 bg-emerald-100 rounded-2xl flex items-center justify-center text-emerald-600 mb-4 sm:mb-6 group-hover:scale-110 transition-transform shrink-0">
              <Sprout size={28} className="sm:w-8 sm:h-8" />
            </div>
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-slate-800">Afforestation</h3>
            <p className="text-slate-600 text-xs sm:text-sm lg:text-base leading-relaxed">
              Turning barren patches into breathing micro-forests. We plant native species to restore the ecological balance.
            </p>
          </div>
          
          <div className="p-6 sm:p-8 bg-white rounded-2xl sm:rounded-[2rem] border border-emerald-50 shadow-sm hover:shadow-xl hover:shadow-emerald-100/50 transition-all duration-300 group hover:-translate-y-1">
            <div className="w-12 sm:w-16 h-12 sm:h-16 bg-teal-100 rounded-2xl flex items-center justify-center text-teal-600 mb-4 sm:mb-6 group-hover:scale-110 transition-transform shrink-0">
              <CloudRain size={28} className="sm:w-8 sm:h-8" />
            </div>
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-slate-800">Water Conservation</h3>
            <p className="text-slate-600 text-xs sm:text-sm lg:text-base leading-relaxed">
              Plants are natural dams. Our tree drives are strategically planned to prevent soil erosion and improve groundwater.
            </p>
          </div>

          <div className="p-6 sm:p-8 bg-white rounded-2xl sm:rounded-[2rem] border border-emerald-50 shadow-sm hover:shadow-xl hover:shadow-emerald-100/50 transition-all duration-300 group hover:-translate-y-1 sm:col-span-2 lg:col-span-1">
            <div className="w-12 sm:w-16 h-12 sm:h-16 bg-lime-100 rounded-2xl flex items-center justify-center text-lime-600 mb-4 sm:mb-6 group-hover:scale-110 transition-transform shrink-0">
              <Sun size={28} className="sm:w-8 sm:h-8" />
            </div>
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-slate-800">Climate Action</h3>
            <p className="text-slate-600 text-xs sm:text-sm lg:text-base leading-relaxed">
              Fighting the rising temperatures of our cities by creating green canopies that provide shade and oxygen.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* --- BENTO GRID GALLERY --- */}
      <section className="w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-10 max-w-7xl mx-auto">
        <div className="mb-6 sm:mb-10 pl-3 sm:pl-4 border-l-4 border-emerald-500">
          <h2 className="text-2xl sm:text-3xl font-bold text-slate-800 tracking-tight">Nature's Gallery</h2>
          <p className="text-slate-500 text-xs sm:text-sm mt-1">Snapshots from our recent plantation drives.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 auto-rows-[200px] sm:auto-rows-[240px] lg:auto-rows-[280px] gap-3 sm:gap-4 lg:gap-6">
          {cards.map((card) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-emerald-950/90 via-emerald-900/20 to-transparent opacity-70 sm:opacity-60 transition-opacity duration-300 group-hover:opacity-85" />
              ...
              <div className="absolute bottom-0 left-0 p-4 sm:p-5 lg:p-6 translate-y-0 sm:translate-y-2 transition-transform duration-300 group-hover:translate-y-0">
                ...
                <h3 className="text-base sm:text-xl lg:text-2xl font-semibold text-white mt-0.5 sm:mt-1 font-serif">
                  {card.title}
                </h3>
              </div>
            </div>
      ...
      {/* --- THE SUCCESS STORY --- */}
      <section className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 bg-emerald-950 text-white overflow-hidden relative mt-8 sm:mt-12">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center relative z-10">
          ...
          >
            ...
            <img 
              src={imgHero1}
              loading="lazy"
              className="rounded-2xl sm:rounded-[2.5rem] lg:rounded-[3rem] relative z-10 shadow-2xl border-2 sm:border-4 border-emerald-900/50 w-full object-cover h-64 sm:h-80 md:h-[400px]"
              alt="Deep Forest"
            />
            
            {/* Floating Stats Card */}
            <div className="absolute -bottom-4 -right-2 sm:-bottom-6 sm:-right-4 md:-right-6 bg-white text-emerald-900 p-4 sm:p-6 lg:p-8 rounded-2xl sm:rounded-3xl z-20 shadow-2xl">
              <div className="flex items-center gap-2 mb-1">
                <TreeDeciduous className="text-emerald-600 w-4 h-4 sm:w-5 sm:h-5 shrink-0" />
                <span className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-emerald-600">Total Impact</span>
              </div>
              <p className="text-2xl sm:text-4xl lg:text-5xl font-black">5,000+</p>
              <p className="text-slate-500 text-xs sm:text-sm font-medium mt-0.5">Trees Planted</p>
            </div>
          </motion.div>
          ...
          >
            <h2 className="text-emerald-400 font-bold tracking-widest uppercase text-xs sm:text-sm mb-2 sm:mb-4">Project: Green Shield</h2>
            <h3 className="text-3xl sm:text-4xl lg:text-5xl font-black mb-4 sm:mb-8 leading-tight font-serif">
              From Dust to <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-lime-400">Dense Canopy</span>
            </h3>
            <div className="space-y-4 sm:space-y-6 text-emerald-100/80 text-sm sm:text-base lg:text-lg leading-relaxed">
              <p>
                What started as a barren patch of land near the industrial bypass is now a thriving micro-ecosystem.
              </p>
              <p>
      ...
      <section className="py-14 sm:py-20 lg:py-24 px-4 sm:px-6 max-w-5xl mx-auto">
        <div className="text-center mb-10 sm:mb-16">
          <Flower2 className="mx-auto text-emerald-600 mb-3 sm:mb-4" size={36} />
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black mb-3 sm:mb-4 text-slate-800">The Story of a Single Seed</h2>
          <div className="h-1.5 w-20 sm:w-24 bg-emerald-500 mx-auto rounded-full" />
        </div>

        <div className="bg-[#FDFCF0] rounded-2xl sm:rounded-[2.5rem] lg:rounded-[3rem] p-6 sm:p-10 md:p-16 shadow-xl border border-stone-200 relative overflow-hidden">
          <Leaf className="absolute -right-8 -bottom-8 sm:-right-10 sm:-bottom-10 text-stone-900/5 rotate-[-20deg] pointer-events-none" size={260} />
          
          <div className="relative z-10 text-stone-700">
            <p className="text-lg sm:text-2xl font-serif italic text-emerald-900 mb-8 sm:mb-12 border-l-4 border-emerald-500 pl-4 sm:pl-8 leading-relaxed">
              "When you plant a tree, you don't just plant a seed. You plant shade for the weary, fruit for the hungry, and breath for the living."
            </p>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-10 lg:gap-12 mb-8 sm:mb-12 text-sm sm:text-base leading-relaxed">
              <p>
                In the heat of May, the temperatures in Jabalpur soar. But walk into the Kaarwaa.N... grove, and the temperature drops by 4 degrees. This isn't magic; it's biology working its miracle.
              </p>
              <p>
            ...
            <div className="bg-emerald-100/50 p-5 sm:p-8 rounded-2xl sm:rounded-3xl mb-8 sm:mb-12 border border-emerald-200">
              <h4 className="text-emerald-900 font-bold mb-3 flex items-center gap-2 text-sm sm:text-base">
                <Heart size={18} className="fill-emerald-600 text-emerald-600 shrink-0" /> A Volunteer's Note
              </h4>
              <p className="text-emerald-900 leading-relaxed italic text-sm sm:text-base">
                "I used to think climate change was too big for me to solve. Then I held a sapling. It was small, but it was alive. Putting it in the earth felt like a promise to the future."
              </p>
              <p className="mt-3 sm:mt-4 font-bold text-emerald-800 text-xs sm:text-sm uppercase">— Karan Sahu, 3rd Year Student</p>
            </div>

            <div className="flex flex-col sm:flex-row items-center justify-between pt-6 sm:pt-8 border-t border-stone-200 gap-5 text-center sm:text-left">
              <div>
                <p className="text-xs sm:text-sm text-stone-400 uppercase tracking-widest font-bold">Initiative By</p>
                <p className="text-base sm:text-lg font-bold text-stone-800">Kaarwaa.N... Green Team</p>
              </div>
              <Link to="/donate" className="w-full sm:w-auto">
                <button className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4 bg-emerald-900 text-white rounded-full font-bold hover:bg-emerald-700 active:scale-95 transition-all group shadow-lg text-sm sm:text-base">
                  Adopt a Sapling <Shovel size={16} className="group-hover:-translate-y-0.5 transition-transform" />
                </button>
              </Link>
            </div>
          </div>
