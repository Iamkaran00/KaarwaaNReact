    ...
    <footer className="relative pt-10 overflow-hidden bg-gradient-to-b from-[#101828] to-[#05080f] text-slate-300 font-sans">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 mb-8">
          ...
          {/* Column 1: Quick Links */}
          <div className="text-left">
            <h6 className="text-white text-base sm:text-lg font-bold mb-4 relative inline-block tracking-wide">
              <span className="flex items-center gap-2">
                <LinkIcon className="text-amber-500 w-4 h-4" /> Quick Links
              </span>
              <span className="absolute left-0 -bottom-2 w-8 h-1 bg-amber-500 rounded-full"></span>
              ...
              {['FAQ', 'Privacy Policy', 'Certificate Verification', 'Feedback', 'Developers'].map((item) => (
                <li key={item}>
                  <a 
                    ...
                    className="hover:text-amber-400 hover:translate-x-1.5 transition-all duration-300 inline-block text-sm"
                  >
                    {item}
                  </a>
                </li>
          ...
          <div className="text-left sm:col-span-2 lg:col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                <Phone className="text-amber-500 w-4 h-4 mr-3 shrink-0" />
                <span className="text-sm break-words">+91 91497 20731 (Saurabh Patel 2023-27)</span>
              </li>
              <li className="flex items-center">
                <Mail className="text-amber-500 w-4 h-4 mr-3 shrink-0" />
                <a href="mailto:kaarwaanjec@gmail.com" className="text-sm hover:text-amber-400 transition-colors break-all">
                  kaarwaanjec@gmail.com
                </a>
              </li>
            </ul>

            <div className="mt-6">
              <p className="mb-2.5 text-slate-500 text-xs uppercase tracking-widest font-semibold">Connect with us:</p>
              <div className="flex space-x-3">
                <a 
                  href="https://www.instagram.com/kaarwaa.n?igsh=ZDF0c3Nham1rOWZk" 
                  target="_blank" 
                  rel="noreferrer"
                  className="w-9 h-9 flex items-center justify-center rounded-full border border-white/10 bg-white/5 text-white transition-all duration-300 hover:bg-[#d62976] hover:border-[#d62976] hover:-translate-y-1 shadow-lg"
                >
                ...
                <a 
                  href="https://www.facebook.com/kaarwaanjec?mibextid=rS40aB7S9Ucbxw6v" 
                  target="_blank" 
                  rel="noreferrer"
                  className="w-9 h-9 flex items-center justify-center rounded-full border border-white/10 bg-white/5 text-white transition-all duration-300 hover:bg-[#1877F2] hover:border-[#1877F2] hover:-translate-y-1 shadow-lg"
                >
                ...
                <a 
                  href="http://www.youtube.com/@kaarwaanjec9417" 
                  target="_blank" 
                  rel="noreferrer"
                  className="w-9 h-9 flex items-center justify-center rounded-full border border-white/10 bg-white/5 text-white transition-all duration-300 hover:bg-[#FF0000] hover:border-[#FF0000] hover:-translate-y-1 shadow-lg"
                >
      ...
      {/* Watermark Branding */}
      <div className="w-full flex justify-center text-center mt-4 sm:mt-8 pb-2 select-none pointer-events-none relative z-0 overflow-hidden">
        <h1 
          className="font-black text-[13vw] uppercase leading-none tracking-wider whitespace-nowrap opacity-100"
          style={{
            WebkitTextStroke: '1px rgba(255, 255, 255, 0.05)',
            color: 'transparent'
          }}
